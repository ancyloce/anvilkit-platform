...
type ClientInterface interface {
	...
	// IssueAgentArtifactContentGrantWithBody Issue a bounded, expiring grant to read one artifact's bytes.
	//
	// Content is disclosed through a grant rather than from the metadata route, so reading bytes is always a recorded, time-boxed decision. The declared access purpose is audited with the verified accessor, the tenant, the artifact, and the trace before any grant is issued.
	//
	// Takes any type of body and a specified content type.
	//
	// Corresponds with POST /workspaces/{workspaceId}/artifacts/{artifactId}/content-grant (the `IssueAgentArtifactContentGrant` operationId).
	...
	// IssueAgentArtifactContentGrant Issue a bounded, expiring grant to read one artifact's bytes.
	//
	// Content is disclosed through a grant rather than from the metadata route, so reading bytes is always a recorded, time-boxed decision. The declared access purpose is audited with the verified accessor, the tenant, the artifact, and the trace before any grant is issued.
	//
	// Takes a body of the `application/json` content type.
...
// NewIssueAgentArtifactContentGrantRequestWithBody constructs an http.Request for the IssueAgentArtifactContentGrant method, with any body, and a specified content type
...
type ClientWithResponsesInterface interface {
	...
	// IssueAgentArtifactContentGrantWithBodyWithResponse Issue a bounded, expiring grant to read one artifact's bytes.
	//
	// Content is disclosed through a grant rather than from the metadata route, so reading bytes is always a recorded, time-boxed decision. The declared access purpose is audited with the verified accessor, the tenant, the artifact, and the trace before any grant is issued.
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	...
	// IssueAgentArtifactContentGrantWithResponse Issue a bounded, expiring grant to read one artifact's bytes.
	//
	// Content is disclosed through a grant rather than from the metadata route, so reading bytes is always a recorded, time-boxed decision. The declared access purpose is audited with the verified accessor, the tenant, the artifact, and the trace before any grant is issued.
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
...
// IssueAgentArtifactContentGrantResponse201Headers the declared response headers of an HTTP 201 response for IssueAgentArtifactContentGrant
type IssueAgentArtifactContentGrantResponse201Headers struct {
	IdempotencyReplayed    *bool
	XAnvilKitRequestDigest *string
}
...
type IssueAgentArtifactContentGrantResponse struct {
	...
	ApplicationproblemJSON500 *ProblemDetails
	// Headers201 the parsed response headers for an HTTP 201 response
	Headers201 *IssueAgentArtifactContentGrantResponse201Headers
}

// GetJSON201 returns the response for an HTTP 201 `application/json` response
func (r IssueAgentArtifactContentGrantResponse) GetJSON201() *ArtifactContentGrant {
	return r.JSON201
}

// GetApplicationproblemJSON400 returns the response for an HTTP 400 `application/problem+json` response
func (r IssueAgentArtifactContentGrantResponse) GetApplicationproblemJSON400() *ProblemDetails {
	return r.ApplicationproblemJSON400
}

// GetApplicationproblemJSON401 returns the response for an HTTP 401 `application/problem+json` response
func (r IssueAgentArtifactContentGrantResponse) GetApplicationproblemJSON401() *ProblemDetails {
	return r.ApplicationproblemJSON401
}

// GetApplicationproblemJSON403 returns the response for an HTTP 403 `application/problem+json` response
func (r IssueAgentArtifactContentGrantResponse) GetApplicationproblemJSON403() *ProblemDetails {
	return r.ApplicationproblemJSON403
}

// GetApplicationproblemJSON404 returns the response for an HTTP 404 `application/problem+json` response
func (r IssueAgentArtifactContentGrantResponse) GetApplicationproblemJSON404() *ProblemDetails {
	return r.ApplicationproblemJSON404
}

// GetApplicationproblemJSON409 returns the response for an HTTP 409 `application/problem+json` response
func (r IssueAgentArtifactContentGrantResponse) GetApplicationproblemJSON409() *ProblemDetails {
	return r.ApplicationproblemJSON409
}

// GetApplicationproblemJSON412 returns the response for an HTTP 412 `application/problem+json` response
func (r IssueAgentArtifactContentGrantResponse) GetApplicationproblemJSON412() *ProblemDetails {
	return r.ApplicationproblemJSON412
}

// GetApplicationproblemJSON422 returns the response for an HTTP 422 `application/problem+json` response
func (r IssueAgentArtifactContentGrantResponse) GetApplicationproblemJSON422() *ProblemDetails {
	return r.ApplicationproblemJSON422
}

// GetApplicationproblemJSON428 returns the response for an HTTP 428 `application/problem+json` response
func (r IssueAgentArtifactContentGrantResponse) GetApplicationproblemJSON428() *ProblemDetails {
	return r.ApplicationproblemJSON428
}

// GetApplicationproblemJSON500 returns the response for an HTTP 500 `application/problem+json` response
func (r IssueAgentArtifactContentGrantResponse) GetApplicationproblemJSON500() *ProblemDetails {
	return r.ApplicationproblemJSON500
}

// GetBody returns the raw response body bytes
func (r IssueAgentArtifactContentGrantResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r IssueAgentArtifactContentGrantResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
func ParseIssueAgentArtifactContentGrantResponse(rsp *http.Response) (*IssueAgentArtifactContentGrantResponse, error) {
	...
	switch {
	case rsp.StatusCode == 201:
		var headers IssueAgentArtifactContentGrantResponse201Headers
		if values := rsp.Header.Values("Idempotency-Replayed"); len(values) > 0 {
			var value bool
			if err := runtime.BindStyledParameterWithOptions("simple", "Idempotency-Replayed", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "boolean", Format: ""}); err != nil {
				return nil, err
