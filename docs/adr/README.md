...
| [ADR-026](ADR-026-component-agent-decision-baseline.md) | Component Agent decision baseline D1–D17 and suite governance (catalog authority, build-worker repository/language, Studio BFF access, identity/tenancy, preview origin, object-store and scheduler implementation status, plan 0006 §18 answer) | **Accepted** (2026-09-01) — approved by Rhett, who holds every role in ADR §6 (OI-01 complete); D1–D17 frozen; conditions carried as amendments K-1…K-7 (see ADR Status): D3/D15 and D4/D16 joint, D6 a commitment on OI-03/OI-11, D9 with the M0-06 readings, D13 on OI-02 + AS-M0-04, D17 with the plan 0006 §2.2/§18 amendment applied the same day; the new build-worker submodule still needs separate team confirmation (K-6). Acceptance packet: `docs/acceptance/component-agent/m0/m0-02-decision-freeze-packet.md` |
